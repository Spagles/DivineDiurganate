...
namespace DivineDiurganate
{
    public class QuestNode_Root_EventLetter : QuestNode
    {
        ...
        protected override void RunInt()
        {
            ...
            {
                Log.Message("[WulaFallenEmpire] QuestNode_Root_EventLetter: eventDefName is not specified.");
            }
        }
        ...
        protected override bool TestRunInt(Slate slate)
        {
            ...
            if (eventDef == null)
            {
                Log.Message($"[WulaFallenEmpire] QuestNode_Root_EventLetter: EventDef '{defName}' not found.");
                return false;
            }
        ...
        private void OpenEventDefWindow(string defName)
        {
            ...
            {
                Log.Message($"[WulaFallenEmpire] QuestNode_Root_EventLetter: Could not find EventDef '{defName}'");
            }
        }
    }
}
